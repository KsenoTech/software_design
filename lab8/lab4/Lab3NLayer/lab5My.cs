...
{
    public partial class lab5My : Form
    {
        ...
        public lab5My(IMotoService motoservice, IOrderService orderservice, IReportService reportservice)
        {
        ...
        {
            //loadMotos();
            //dataGridBindingSourceOrder.Refresh();
            bindingSourceMoto.ResetBindings(true);
            Application.Restart();
